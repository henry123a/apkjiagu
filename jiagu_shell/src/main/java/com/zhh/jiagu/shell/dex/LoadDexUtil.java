...
//            }
            ...
            if (!dexFile.exists()) {
                ...
                boolean newFile = dexFile.createNewFile();//在payload_odex文件夹内，创建payload.apk
                if (!newFile) {
    ...
    public static void replaceAndRunMainApplication(Application app) {
        ...
        Application oldApplication = (Application) RefInvoke.getFieldOjbect("android.app.ActivityThread", currentActivityThread, "mInitialApplication");
...
//        appinfo_In_LoadedApk.className = appClassName;
        assert appinfo_In_AppBindData != null;
